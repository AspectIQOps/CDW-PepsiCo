...
echo ""
echo "   ✅ Materialized views created (11 views: 8 analytics + 3 license overage)"
echo ""
...
echo "   ✅ Sectors: $SECTORS_COUNT (populated from ServiceNow CMDB)"
echo "   ✅ Capabilities: $CAPS_COUNT (AppD license types: APM, BRUM, MRUM, INFRA, ANALYTICS)"
