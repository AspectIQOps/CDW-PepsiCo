...
# SOW Section 2.1 & 2.3: License overage tracking and capacity planning views added
MATERIALIZED_VIEWS = [
    ...
    # License Overage Tracking (SOW 2.1 & 2.3)
    'mv_current_license_entitlements',   # Priority 1 - contracted capacity
    'mv_license_overage_daily',          # Priority 1 - daily overage analysis
    'mv_license_overage_monthly',        # Priority 2 - monthly overage summary
]
...
def analyze_views(conn, view_names):
    ...
    cursor = conn.cursor()
    print(f"\nSUMMARY: Updating statistics for query planner...")
